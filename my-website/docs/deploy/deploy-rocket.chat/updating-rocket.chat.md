...
<figure><img src="/img/upgrade-path.png" alt=""></img><figcaption></figcaption></figure>
...
[Update Version Path]https://whimsical.com/upgrade-version-path-rocket-chat-51eoS7aUunTan5wLt2CBHU)
...
:::info
If you have any concerns or issues with updating Rocket.Chat, see [updating-faq.md](../../resources/frequently-asked-questions/deployment-faq/updating-faq.md)
:::
