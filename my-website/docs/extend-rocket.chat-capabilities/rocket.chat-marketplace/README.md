...
* **Explore:** View, search, and filter apps based on categories, status, and price. <img src="/img/image (917).png" alt="" data-size="line"/> tag next to an app on the marketplace means you need to upgrade your workspace to a higher version to use the app.
